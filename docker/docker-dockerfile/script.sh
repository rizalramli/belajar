# khannedy = username docker hub

# FROM Instruction
docker build -t khannedy/from 1from

docker image ls

# RUN Instruction
docker build -t khannedy/run 2run

docker build -t khannedy/run 2run --progress=plain --no-cache

# CMD Instruction
docker build -t khannedy/command 3command
...
# LABEL Instruction
docker build -t khannedy/label 4label

docker image inspect khannedy/label

# ADD Instruction
docker build -t khannedy/add 5add
